...
ALTER SEQUENCE skill_skillid_seq RESTART WITH 1000;
ALTER SEQUENCE businesssector_businesssectorid_seq RESTART WITH 1000;
ALTER SEQUENCE websitefeedback_websitefeedbackid_seq RESTART WITH 1000;
ALTER SEQUENCE developmentfeedback_developmentfeedbackid_seq RESTART WITH 1000;
ALTER SEQUENCE account_accountid_seq RESTART WITH 1000;
ALTER SEQUENCE mentor_mentorid_seq RESTART WITH 1000;
ALTER SEQUENCE mentorskill_mentorskillid_seq RESTART WITH 1000;
ALTER SEQUENCE mentee_menteeid_seq RESTART WITH 1000;
ALTER SEQUENCE menteeskill_menteeskillid_seq RESTART WITH 1000;
ALTER SEQUENCE assignment_assignmentid_seq RESTART WITH 1000;
ALTER SEQUENCE meeting_meetingid_seq RESTART WITH 1000;
ALTER SEQUENCE menteemessage_menteemessageid_seq RESTART WITH 1000;
ALTER SEQUENCE mentormessage_mentormessageid_seq RESTART WITH 1000;
ALTER SEQUENCE mentorfeedback_mentorfeedbackid_seq RESTART WITH 1000;
ALTER SEQUENCE menteefeedback_menteefeedbackid_seq RESTART WITH 1000;
ALTER SEQUENCE milestone_milestoneid_seq RESTART WITH 1000;
ALTER SEQUENCE workshop_workshopid_seq RESTART WITH 1000;
